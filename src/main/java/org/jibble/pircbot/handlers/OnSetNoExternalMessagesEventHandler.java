...
public class OnSetNoExternalMessagesEventHandler extends AbstractEventHandler {
    public OnSetNoExternalMessagesEventHandler(IrcServerConnection pircBot, String channel, String sourceNick, String sourceLogin, String sourceHostname, String param) {
