...
public class OnSetModeratedEventHandler extends AbstractEventHandler{
    public OnSetModeratedEventHandler(IrcServerConnection pircBot, String channel, String sourceNick, String sourceLogin, String sourceHostname, String param) {
