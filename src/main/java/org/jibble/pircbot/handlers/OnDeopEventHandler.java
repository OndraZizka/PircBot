...
public class OnDeopEventHandler extends AbstractEventHandler {

    public OnDeopEventHandler(IrcServerConnection bot, String channel, String sourceNick, String sourceLogin, String sourceHostname, String param) {
