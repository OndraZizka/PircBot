...
public class OnRemoveModeratedEventHandler extends AbstractEventHandler {
    public OnRemoveModeratedEventHandler(IrcServerConnection pircBot, String channel, String sourceNick, String sourceLogin, String sourceHostname, String param) {
