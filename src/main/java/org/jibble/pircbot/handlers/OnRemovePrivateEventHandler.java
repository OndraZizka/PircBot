...
public class OnRemovePrivateEventHandler extends AbstractEventHandler {
    public OnRemovePrivateEventHandler(IrcServerConnection pircBot, String channel, String sourceNick, String sourceLogin, String sourceHostname, String param) {
